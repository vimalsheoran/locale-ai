...
function Client(server) {
	...
	this.listenOnSocket = async () => {
		...
		Client.socket.on("success", msg => console.log("Successfully registered packet: ", msg));
		Client.socket.on("failure", msg => console.log("Failed to register packet: "+msg+". Please consider retrying."));
	}
}
